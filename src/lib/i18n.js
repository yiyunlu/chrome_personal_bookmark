...
const dictionaries = {
  'zh-CN': {
    ...
    selectedSuffix: '项',
    batchMove: '移动到…',
    batchOpenWindow: '在新窗口打开',
    moveToTrash: '删除到回收站',
    clearSelection: '清空',
    loading: '加载中...',
    noBookmarks: '暂无可显示书签',
    noBookmarksHint: '点击「保存标签页」将当前打开的网页保存到此处',
    emptySearchTitle: '没有匹配的书签',
    emptySearchHint: '试试更短的关键词，或换一个分类',
    emptyCollectionTitle: '这个分类还是空的',
    emptyCollectionHint: '把当前标签页保存进来，或用「自动整理」填充',
    clearFilters: '清除筛选',
    items: '项',
  ...
  en: {
    ...
    themeLight: 'Light',
    themeDark: 'Dark',
    themeSwitchTo: (label) => `Switch to ${label}`,
    language: 'Language',
    ...
    unfiledNoActions: 'Unfiled cannot be renamed or deleted',
    ...
    selectedSuffix: '',
    batchMove: 'Move to…',
    batchOpenWindow: 'Open in New Window',
    moveToTrash: 'Move to Trash',
    clearSelection: 'Clear',
    loading: 'Loading...',
    noBookmarks: 'No bookmarks to display.',
    noBookmarksHint: 'Click "Save Tabs" to save your open tabs here',
    emptySearchTitle: 'No matching bookmarks',
    emptySearchHint: 'Try a shorter keyword, or switch collections',
    emptyCollectionTitle: 'This collection is still empty',
    emptyCollectionHint: 'Save your open tabs here, or fill it with Auto-organize',
